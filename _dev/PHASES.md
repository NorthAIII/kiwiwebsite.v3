...
**Near-term içerik faz konusu yok** — v0.4'ün içerik fazı (Faz 15) ✅; versiyon-sonu **teknik borç fazı Faz 16 olarak girildi** (discuss-phase 16, 2026-07-16) → Faz Durumu tablosunda 🔄.

> Faz 16 (teknik borç) bitince sıradaki versiyon-sonu sabit fazı: **senaryo testi** → sonra zorunlu prd-review (dinamik, faza girince doğrudan tabloya eklenir).
...
**Son Güncelleme:** 2026-07-16 — discuss-phase 16: Faz 16 (v0.4 versiyon-sonu teknik borç) tabloya 🔄; `içerik_fazları`→`teknik_borç` damgalandı; kapsam gym PNG hijyeni + npm audit. **Kullanıcı önceliğiyle v0.4 TR production release yapıldı** (canlı `f173234` — `docs/RELEASE-v0.4.md`); non-TR çeviri + senaryo testi arkada. Sıradaki adım research-phase 16.
