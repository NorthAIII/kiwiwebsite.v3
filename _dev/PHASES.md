...
**Son Güncelleme:** 2026-07-03 — discuss-phase 13: Faz 13 (v0.3 versiyon-sonu teknik borç — SEO-metadata hijyeni) girildi, Faz Durumu tablosuna 🔄 eklendi. Versiyon Sonu Durumu `içerik_fazları`→`teknik_borç` damgalandı; kapsam TB-1 (canonical + hreflang alternates) + TB-2 (`/forum` locale gap + tüm redirect denetimi) + hafif regresyon tohumu. TB-3/TB-4/TB-5 kayıtlı açık; B grubu → prd-review. Sıradaki adım: research-phase 13.
