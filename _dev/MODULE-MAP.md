...
| R1: "Nasıl çalışır" 3→4 adım (Analiz·Çözüm·Otomasyon·Raporlama) | M2 (+M4) | v0.1 | — | ⬜ |
| R2: Sektörler gym paneli tek-otomasyon desenine | M2 (+M4) | v0.1 | — | ⬜ |
| R3: Crew OS bölümü içerik teyidi (panel akışları bırakıldı) | M2 (+M4) | v0.1 | — | ⬜ |
| R4: Ana sayfa TR kopya/ses revizesi (F5 dürüstlük + F6 hero ikincil CTA) | M2 + M4 | v0.1 | — | ⬜ |
...
**Son Güncelleme:** 2026-06-28 — kickoff-docs: taksonomi (Crew OS public / Bunker OS iç) netleştirildi; v0.1 revize iş birimleri (R1–R4, M2+M4) eklendi.
