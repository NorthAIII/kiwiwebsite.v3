...
│   ├── F2.5: Bunker (Crew OS teaser bölümü)               → —
│   ├── F2.6: Bülten/Forum bölümü + makale sayfaları       → —
│   ├── F2.7: Bunker OS showcase sayfası                   → —
...
- **M1 → M2/M3/M5:** Tasarım token'ları (renk/tipografi/tema) ve Living Flow tüm görünür yüzeyin tabanıdır; Hero, Bunker OS, Alpfit sayfaları ve chatbot "thinking" durumu Living Flow motifini kullanır.
...
| F2.5: Bunker (Crew OS teaser) | M2 | v3 (mevcut) | — | ✅ |
| F2.6: Bülten/Forum + makaleler | M2 | v3 (mevcut) | — | ✅ |
| F2.7: Bunker OS sayfası | M2 | v3 (mevcut) | — | ✅ |
...
**Son Güncelleme:** 2026-06-27 — map-codebase: mevcut kodbazdan 6 modül ve mevcut feature'lar haritalandı.
