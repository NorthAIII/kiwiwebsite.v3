...
**Son Güncelleme:** 2026-07-18 — review-phase 17: [runtime-harness-selector-teyidi](memory/runtime-harness-selector-teyidi.md)'ye **"şüpheyi belirleyici probe ile kapat"** disiplini eklendi (Süreç Disiplinleri) — harness beklenmedik sonuç verdiğinde şüphe, harness'ın kısıtını **paylaşmayan** bağımsız bir substratta (gerçek middleware'li canlı site / tam-doküman navigasyon / gerçek UI affordance'ı / statik kaynak grep) yeniden koşularak kapatılır; aynı harness içinde assertion gevşetmek kanıt değildir. Faz 17'de 5 şüphenin 5'i böyle kapandı (BULGU-S2/S9 artefakt, 0 yanlış bug raporu, 0 sessizce yutulmuş bulgu).
