...
**Son Güncelleme:** 2026-07-02 — review-phase 9: Süreç Disiplinleri'ne [runtime-harness-selector-teyidi](memory/runtime-harness-selector-teyidi.md) eklendi — standalone Playwright harness'i yazarken komponent etkileşim mekanizmasını kaynaktan teyit et (LanguageSwitcher router-buton / Chatbot inline `#chat` / tema `html.dark`+localStorage); Faz 9 runtime ilk-koşu 3 yanlış-FAIL selector artefaktından çıkan disiplin.
