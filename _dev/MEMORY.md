...
**Son Güncelleme:** 2026-09-11 — TASK-18.08 (go-live): yeni öğrenim [groq-model-emekliligi](memory/groq-model-emekliligi-runtime-404.md) — üçüncü-parti model adı bozulabilir bağımlılıktır, emeklilik yalnız canlı runtime log'unda görünür (build/test/curl-200 üçü de yanıltır). "Chatbot env" satırı model varsayılanı `qwen/qwen3.8-27b`'ye hizalandı.
