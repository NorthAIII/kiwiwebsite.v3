...
**Son Güncelleme:** 2026-07-22 — TASK-18.01: [vercel-git-disconnect](memory/vercel-git-disconnect-deploy-tetiklenmez.md)'e **auth'suz deploy-teyidi** (repo public → GitHub `/deployments` + `/commits/<sha>/statuses` `context=Vercel`) + **no-op/doc-merge diskriminatörü** (byte-identical çıktıda yeni-string yok → o merge'e özgü gözlemlenebilir fark, ör. orphan PNG 200→404) eklendi.
