...
**Son Güncelleme:** 2026-09-11 — TASK-18.10: F5.1 system prompt tarifine iki kural eklendi — **betimleyici CTA atfı** (sabit buton etiketi gömülmez, alıntılanmaz) ve **dil-başına hitap düzeyi** (TR/DE formal · ES samimi · AR ikinci tekil · EN nötr); kabul kriterlerine karşılığı yazıldı (UAT 18 senaryo 28/29, DECISIONS 2026-09-11). Sanitizasyon tarifi ve `max_tokens: 512` değişmedi.
