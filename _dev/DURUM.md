...
**Aktif Task:** Aktif task yok — **Faz 10 planlaması ✅** (plan-phase, 4 task yazıldı). İlk çalıştırılacak TASK-10.01. Sıradaki adım **verify-plan 10** (yeni oturum). **run-task 10'dan ÖNCE bekleyen operasyonel adım: v0.2 production release** — hafif oturum + checklist, runbook `docs/RELEASE-v0.2.md` (temiz v0.2 penceresi açık; hemen/sonraki oturum önerilir; Umami canlı +1 orada kapanır).
